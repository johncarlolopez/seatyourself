...
Restaurant.create(name: "Frankie Tomatto's", address: "7225 Woodbine Ave", city: "Markham", price_range: "2", summary: "Italian buffet, what more could you want? Another meatball?", menu: "SPEGGHETTI AND MEATBALLS, GARLIC BREAD, LASAUGNA, PIZZA, SEAFOOD, SALADS", opening_time: Time.now, closing_time: Time.now + 4.hours, capacity: 60, user_id: 1)
Restaurant.create(name: "Applebee's", address: "5700 Mavis Rd", city: "Mississauga", price_range: "3", summary: "Full-service chain bar & grill providing hearty American eats in an informal setting", menu: "BBQ PORK BACK RIBS, MAPLE GLAZED SALMON, CHICKEN TENDER PLATTER, DOUBLE CRUNCH SHRIMP", opening_time: Time.now, closing_time: Time.now + 4.hours, capacity: 60, user_id: 1)
